...
export type DisplayStatus =
  | "PENDING" | "HOLD" | "IN_PROCESS" | "PARTIAL" | "DISPATCHED" | "CANCELLED";
...
export const DISPLAY_STATUS_FILTERS: { value: DisplayStatus; label: string }[] =
  (["PENDING", "HOLD", "IN_PROCESS", "PARTIAL", "DISPATCHED", "CANCELLED"] as const)
...
export function displayStatusOf(
  row: { status?: string | null; display_status?: string | null },
): DisplayStatus {
