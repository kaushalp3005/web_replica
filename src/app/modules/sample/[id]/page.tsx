...
export default function SampleDetailPage() {
  ...
  // Arriving from the overdue-dispatch reminder mail's Cancel / Change date buttons →
  // pop the matching dialog bound to that request + email + token. Strip the params so a
  // manual refresh doesn't re-fire the action. Runs once on mount (client-only — no SSR
  // query access needed).
  useEffect(() => {
